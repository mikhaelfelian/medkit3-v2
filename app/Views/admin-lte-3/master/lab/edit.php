                ...
                <div class="form-group">
                    ...
                    <select name="merk"
                        ...
                        <?php foreach ($merks as $merk): ?>
                            <option value="<?= $merk->id ?>" <?= old('id_merk', $lab->id_merk) == $merk->id ? 'selected' : '' ?>>
                                <?= esc($merk->merk) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <select name="remun_tipe" class="form-control rounded-0">
                                ...
                                <option value="1" <?= old('remun_tipe', $lab->remun_tipe) == '1' ? 'selected' : '' ?>>Persen</option>
                                <option value="2" <?= old('remun_tipe', $lab->remun_tipe) == '2' ? 'selected' : '' ?>>Nominal</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
                            <input type="text" class="form-control rounded-0" id="remun_perc" name="remun_perc" 
                                value="<?= old('remun_perc', $lab->remun_perc) ?>"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input type="text" class="form-control rounded-0 currency" id="remun_nom" name="remun_nom"
                                value="<?= old('remun_nom', $lab->remun_nom) ?>" 
                                placeholder="Masukkan nominal" onkeyup="formatCurrency(this)">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <select name="apres_tipe" class="form-control rounded-0">
                                <option value="">[Tipe]</option>
                                <option value="1" <?= old('apres_tipe', $lab->apres_tipe) == '1' ? 'selected' : '' ?>>Persen</option>
                                <option value="2" <?= old('apres_tipe', $lab->apres_tipe) == '2' ? 'selected' : '' ?>>Nominal</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
                            <input type="text" class="form-control rounded-0" id="apres_perc" name="apres_perc"
                                value="<?= old('apres_perc', $lab->apres_perc) ?>"
                                placeholder="Masukkan %" oninput="validateNumber(this)" maxlength="3">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input type="text" class="form-control rounded-0 currency" id="apres_nom" name="apres_nom"
                                value="<?= old('apres_nom', $lab->apres_nom) ?>"
                                placeholder="Masukkan nominal" onkeyup="formatCurrency(this)">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" name="status" value="1"
                            id="statusAktif" <?= old('status', $lab->status) == '1' ? 'checked' : '' ?>>
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" name="status" value="0"
                            id="statusNonaktif" <?= old('status', $lab->status) == '0' ? 'checked' : '' ?>>
                                ...
                                foreach ($item_refs as $ref): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= base_url('master/radiologi/item_ref_delete/' . $ref->id) ?>"
