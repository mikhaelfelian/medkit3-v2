...
<div class="row">
    ...
    <div class="col-9">
        <div class="card rounded-0">
            <div class="card-header">
                <h3 class="card-title">Pasien Lama</h3>
                ...
                <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="jns_klm" id="jns_klm"
                                        ...
                                        <option value="L" <?= old('jns_klm', $pasien->jns_klm ?? '') == 'L' ? 'selected' : '' ?>>
                                            Laki-laki</option>
                                        <option value="P" <?= old('jns_klm', $pasien->jns_klm ?? '') == 'P' ? 'selected' : '' ?>>
                                            Perempuan</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?= form_input([
                                        ...
                                        'id' => 'tgl_lahir',
                                        'name' => 'tgl_lahir',
                                        'value' => tgl_indo9($pasien->tgl_lahir),
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_masuk" class="form-control rounded-0" required value="<?= date('Y-m-d') ?>">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-footer text-right">
                <?= anchor('medrecords/daftar?tipe_pas=1', '<i class="fas fa-arrow-left mr-2"></i>Kembali', [
